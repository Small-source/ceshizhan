    ...
    .xuankeyuanxiao {
        ...
        .el-checkbox {
            .el-checkbox__input .el-checkbox__inner {
                ...
                height: 18px;
                border: none;
                background: url(/imgs/elective/majorSelectedSubjects/icon_unchecked.png) no-repeat center center;
            }  
        }
        .is-checked {
            .el-checkbox__input .el-checkbox__inner {
                ...
                height: 18px;
                border: none;
                background: url(/imgs/elective/majorSelectedSubjects/icon_checked.png) no-repeat center center;
                &:after {
                    border: none;
                }
            }  
