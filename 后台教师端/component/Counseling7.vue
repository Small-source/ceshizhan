    ...
    <div class="Counseling7">
    	<div class="main_box">
			...
			<div class="list_box" v-if="tableDetailList">
				<ul>
					<li>
						<img src="/career/imgs/careerManagement/counseling/icon_huangjin.png" alt="">
						<div class="detail_box">
							<p v-for="(item,index) in tableDetailList['黄金时间段']" :key="index">{{item}}</p>
						</div>
					</li>
					<li>
						<img src="/career/imgs/careerManagement/counseling/icon_jingliyiban.png" alt="">
						<div class="detail_box">
							<p v-for="(item,index) in tableDetailList['精力一般']" :key="index">{{item}}</p>
						</div>
					</li>
					<li>
						<img src="/career/imgs/careerManagement/counseling/icon_bijiaokun.png" alt="">
						<div class="detail_box">
							<p v-for="(item,index) in tableDetailList['比较困']" :key="index">{{item}}</p>
						</div>
					</li>
					<li>
						<img src="/career/imgs/careerManagement/counseling/icon_feichangkun.png" alt="">
						<div class="detail_box">
...
<script>
    module.exports = {
        ...
        methods:{
            ...
            getCardDetail(id){
                this.$ajax.post(this.G_uri + '/careerArchives/getCoachPrimeTime',{
            ...
            storeCardDetail(obj){
                this.$ajax.post(this.G_uri + '/careerArchives/storeCoachPrimeTime',{
                  studentId: this.studentId,
                	// id: 
                	detail: obj
                },{
...
.Counseling7 .main_box {
  padding: 0px 20px 20px 20px;
  background-color: #fff;
  margin-bottom: 20px;
  border-radius: 5px;
}
.Counseling7 .main_box h6.title {
  line-height: 64px;
  font-size: 17px;
  color: #348DF1;
  font-weight: bolder;
...
.Counseling7 .main_box h6.title p {
  float: right;
  cursor: pointer;
  margin-top: 20px;
}
.Counseling7 .main_box .list_box ul {
  display: flex;
  justify-content: space-between;
}
.Counseling7 .main_box .list_box ul li {
  background-color: #f8f8fb;
}
.Counseling7 .main_box .list_box ul li .detail_box {
  text-align: center;
  padding: 10px 0px;
}
.Counseling7 .main_box .list_box ul li .detail_box p {
  line-height: 24px;
}
.Counseling7 .main_box .recording {
  border: 1px solid #ebebeb;
  border-radius: 5px;
  height: 132px;
}
.Counseling7 .main_box .recording .top {
  height: 90px;
  line-height: 90px;
  text-align: center;
  cursor: pointer;
...
.Counseling7 .main_box .recording .foot {
  width: 490px;
  margin: 0 auto;
  display: flex;
  justify-content: space-around;
}
.Counseling7 .main_box .recording .foot p {
  font-size: 14px;
  color: #666;
  padding-left: 40px;
}
.Counseling7 .main_box .recording .foot p span {
  color: #358ced;
  cursor: pointer;
}
.Counseling7 .main_box .table_box table tr th {
...
.Counseling7 .main_box .table_box table tr th:nth-child(3) {
  text-align: center;
  width: 15%;
  font-size: 12px;
}
.Counseling7 .main_box .table_box table tr th:nth-child(4) {
  width: 10%;
}
.Counseling7 .main_box .table_box table tr th:nth-child(5) {
  width: 10%;
}
.Counseling7 .main_box .table_box table tr td {
  padding: 10px;
  border: 1px solid #ebebeb;
  line-height: 24px;
}
.Counseling7 .main_box .table_box table tr td:nth-child(3) {
  text-align: center;
  width: 15%;
  font-size: 12px;
}
.Counseling7 .main_box .table_box table tr .icon {
  text-align: center;
  cursor: pointer;
}
.Counseling7 .main_box .table_box table tr .icon span {
  cursor: pointer;
...
.Counseling7 .main_box .table_box table tr .icon_edit span {
  background: url(/career/imgs/careerManagement/icon_bianjihui.png) no-repeat center center;
}
.Counseling7 .main_box .table_box table tr .icon_edit span:hover {
  background-color: #3A90F3;
}
.Counseling7 .main_box .table_box table tr .icon_del span {
  background: url(/career/imgs/careerManagement/icon_lajitonghui.png) no-repeat center center;
}
.Counseling7 .main_box .table_box table tr .icon_del span:hover {
  background-color: #FB4945;
}
.Counseling7 .main_box .detail_btn_box {
  margin-bottom: 20px;
  height: 26px;
  line-height: 26px;
}
.Counseling7 .main_box .detail_btn_box p {
  background: url(/career/imgs/careerManagement/counseling/icon.png) no-repeat 0px center;
  font-weight: 600;
  float: left;
  padding-left: 30px;
}
.Counseling7 .main_box .detail_btn_box .btn_box {
  float: right;
}
.Counseling7 .main_box .detail_btn_box .btn_box .btn {
  float: left;
  margin-left: 16px;
}
.Counseling7 .main_box .page_box {
  padding: 30px;
  display: flex;
  justify-content: center;
}
.Counseling7 .main_box .page_box span {
  line-height: 32px;
  margin-right: 10px;
}
.Counseling7 .mark {
...
.Counseling7 .mark .card .card_title {
  line-height: 60px;
  text-align: center;
  font-size: 17px;
  color: #fff;
...
.Counseling7 .mark .card .card_content {
  padding: 10px 40px;
  background-color: #fff;
  overflow-y: auto;
}
.Counseling7 .mark .card .card_content .remind {
  line-height: 24px;
  font-weight: 600;
  color: #333;
  font-size: 14px;
...
.Counseling7 .mark .card .card_content .radio_boxs li {
  display: flex;
  font-weight: 600;
  font-size: 14px;
  line-height: 40px;
...
.Counseling7 .mark .card .card_content .radio_boxs li .title {
  padding-right: 20px;
  width: 120px;
  text-align: right;
}
.Counseling7 .mark .card .card_content .save {
  width: 76px;
  height: 30px;
  line-height: 30px;
  text-align: center;
