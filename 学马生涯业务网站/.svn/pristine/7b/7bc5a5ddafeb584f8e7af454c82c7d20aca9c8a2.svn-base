<template>
    ...
    <div class="test_main test_main_2">
      ...
      <div class="test_detail test_3">
        <div class="box">
          ...
          <p class="tips">Part B测试完成!</p>
          <div class="btngroup">
            <router-link class="btn btn_goon" to="/shengyaceping/rzqn/guide/123">点击继续</router-link>
          </div>
        </div>
      </div>
    </div>
  ...
  <!--<div class="d-relative xgtz-index xgtx-ques">-->
    ...
    <!--<div class="evalu-part">-->
      ...
      <!--<img src="../../assets/rzqn/partc2.png">-->
    <!--</div>-->
    ...
    <!--<div class="success-tip-wrapper">-->
      ...
      <!--<div class="success-router">-->
        <!--<router-link to="/rzqn/guide/123">点击继续</router-link>-->
      <!--</div>-->
    <!--</div>-->
