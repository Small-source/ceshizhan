<template>
    ...
    <div class="major_selected_subjects">
        <div class="content">
            ...
            <router-view  :src="src" :quanzhong="quanzhong" v-on:go-next="mubiaozhuanyes($event)" :mubiaozhuanye="mubiaozhuanye" :checked="checked"></router-view>
            </div>         
        </div>
    </div>
</template>
    ...
    data() {
        return {
            ...
            quanzhong: [
                ...
                { influenceFactor: '2', influenceFactorWeight: '2', subjectPhysics: '0', subjectChemistry: '0', subjectBiological: '0', subjectIdeologicalPolitics: '0', subjectHistory: '0', subjectGeography: '0', subjectTechnology: '0', titles: '这门科目与我的认知能力相匹配', numbers: '02' },
