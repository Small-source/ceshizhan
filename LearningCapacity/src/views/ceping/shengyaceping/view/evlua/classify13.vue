<template>
  <div class="pc-page">
    <div class="system_main">
      <div class="titbox">
        <p class="font"><span v-html="text"></span> <br>请单击学习态度测评进行测试。</p>
      </div>
      <div class="list">
        ...
        <li class="item item_rg item_rg_over">
          <a href="javascript:;" class="box">
            <em class="icon"></em>
            <h5 class="title">人格特性测评</h5>
          </a>
        </li>
        <li class="item  item_scale item_td cur" >
          <a href="javascript:;" class="box">
            <em class="icon"></em>
            <h5 class="title">学习态度测评</h5>
          </a>
        </li>
        <li class="item  item_xq ">
          <router-link to="/shengyaceping/xqqx" class="box">
            <em class="icon"></em>
