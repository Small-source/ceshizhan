    ...
    export default {
        data() {
            return {
                ...
                arrAs:[
                    ...
                    [4,4,3,3,3,5,5,4,3,4,3,4,5,3,5,3,4,5,3,5,4,4,5,4,5,4],
        ...
        methods: {
            ...
            submit: function () {
                ...
                this.t = null;
                if(this.type=='test'){
                    this.$router.push('/learningAbility/learningPotential/success/92?type=test')
                    return
                }
                // return;
                let _this=this;
                this.$ajax.post(this.G_uri+"/result/cognition/attentionc/compute", {
                    ...
                    function (res) {
                        ...
                        if (data.code == 0) {
                            return;
                            _this.saveNode(1, 93);
                            _this.$router.push('/learningAbility/learningPotential/success/93')
                        } else {
