    ...
    <div class="test_main test_main_3">
      ...
      <div class="test_detail test_3">
        <div class="radio_box">
          ...
          <div class="txt_desc">
            <p>
              1、答案没有正误之分，请根据你是怎样做的或最倾向于如何决定进行选择。 </p>
            <p>
              2、测试的目的是反映最真实的自己。请最大程度放松下来，选择更接近你平时的感受或行为的选项。
            </p>

            <p>
              3、每一个项目均采用5级评分制，1分是完全不符合；2分是比较不符合；3分是一般；4分是比较符合；5分是完全符合。
            </p>
          </div>
          <div class="btngroup test_btngroup">
            <a href="javascript:;" @click="go($event)" url="/shengyaceping/xqqx/3" class="btn btn_start">开始<span
