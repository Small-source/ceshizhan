    ...
    <div class="zizhaozongpingfushi">
        ...
        <div class="content">
            ...
            <div class="inners">
                ...
                <div class="bigTitle">强基&综评冲刺网课</div>
                <p class="jianjie">36所大学强基计划</p>
                <ul class="footLis">
                    <li>考法分析</li>
                    <li>笔试押题</li>
                    <li>面试闯关</li>
            ...
            <div class="contentBox">
                ...
                <div class="title">
                    <img src="/imgs/zaixianketang/icon_biaoti.png" alt="">
                    <span>免费课程</span>
                </div>
                <div class="videoBox1">
                    <div class="inner">
                        <div class="list">
                            <div class="videoBox_left">
                                <video  controls  src="http://video.xuematech.com/bd0fd5fd16074a848a1f55ce86445dca/99729ef0963f4f77a2e89baf6d61c854-2d3958bb222f41d7cc8490cb1c168d03-sd.mp4" poster="/imgs/zaixianketang/mianshi01.png" preload="none">
                                </video>
                            </div>
                            <div class="videoBox_right">
                                <p class="title">强基综评</p>
                                <p class="tese">课程特色</p>
                                <div class="detail">
                                    <p><span>·</span> 以高考为本，强基综评为辅，稳中取胜</p>
                                    <p><span>·</span> 归纳各高校命题规律，有针对性的帮助学生总结备考策略</p>
                                    <p><span>·</span> 线上学习录播课程，突破时间和空间的限制</p>
                                    <p><span>·</span> 讲练结合，配套有最新综合评价真题库</p>
                                </div>
                                <p class="fuli"><span>福利1：</span>免费获得全套笔面试内部教研资料</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="videoBox1">
                    <div class="inner">
                        <div class="list">
                            <div class="videoBox_left">
                                <video  controls  src="http://video.xuematech.com/db59d513c02040a9932b96a32c08f01c/a1235b20bea74fbc8da3428cca893bfe-3db08da40afe876718fa058825b1619f-sd.mp4" poster="/imgs/zaixianketang/shuxue01.png" preload="none">
                                </video>
                            </div>
                            <div class="videoBox_right">
                                <p class="title">强基综评</p>
                ...
                <div class="videoBox1" style="margin-bottom: 0">
                    <div class="inner">
                        <div class="list">
                            <div class="videoBox_left">
                ...
                <div class="courseOutline">
                    <div class="inner">
                        <div class="OutlineContet">
                            <p class="analysis">课程形式为90所院校考法分析、招生简章解读以及复习建议。每位考生选3所志愿院校，进行针对性学习</p>
                            ...
                            <div class="details">
                                ...
                                <table border="1">
                                    <tr>
                                        <th style="border-right: 1px solid #fff">真题</th>
                                        <th>核心内容</th>
                                    </tr>
                                    <tr>
                                        <td>复试考法</td>
...
<style type="text/css" lang='less' scoped>
    .zizhaozongpingfushi {
        ...
        .banner {
            width: 100%;
            height: 480px;
            background: url(/imgs/zaixianketang/banner01.png) no-repeat center center;
        }
        .content {
            background: #F5F5F5;
            padding-bottom: 40px;
                ...
                .lis {
                    ...
                    li {
                        ...
                        .teacherBox{
                            ...
                            padding-left: 15px;
                            padding-right: 15px;
                            background: rgba(53,146,249,0.9);
                            .teacher {
                                font-size: 20px;
                                font-weight: bolder;
                                color: #fff;
...
export default {
    ...
    data() {
        return { 
            ...
            instructors: [
                { imgSrc: '/imgs/zaixianketang/t1.png', teacher: '金  波', university: '清华大学 2015年以712分湖南省第二名的成绩考入清华大学 ' },
                { imgSrc: '/imgs/zaixianketang/t2.png', teacher: '周雅琳', university: '清华大学 环境、化工与新材料大类领军计划初试优秀，免笔试录取' },
                { imgSrc: '/imgs/zaixianketang/t3.png', teacher: '肖世裕', university: '清华大学 物理系领军计划笔试优秀录取' },
                { imgSrc: '/imgs/zaixianketang/t4.png', teacher: '乔  丹', university: '北京师范大学汉语言文学 高考英语142分，曾成功辅导学员通过北大自主招生' },
            ],
            AnchorPoint: '0',
            src: '',
    ...
    mounted() {
        this.getCanView();
        let arr=[700,2450,2800]
        $('.listnavBox>li').eq(0).css({'background':'#3592FA','color':'#fff'})
        $('.listnavBox>li').click(function () {
            let index=$(this).index();
            $('.listnavBox>li').css({'background':'','color':''})
            $(this).css({'background':'#3592FA','color':'#fff'})
            window.scroll(0,arr[index])
        })
    },
    created() {
