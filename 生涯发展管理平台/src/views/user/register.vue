<template>
    <div class="register">
        ...
        <div class="chongzhimimachenggong" v-if="success">
            ...
            <h5 class="success">恭喜您注册成功</h5>
            <p class="baoguan">请妥善保管您的账户信息</p>
            <button @click="$router.push('/perfectInformation')">下一步</button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            Submission() {
                ...
                this.$ajax.post(this.G_uri + this.ports.user.register, {
                    phone: phone,
                    code: code,
            ...
            getKeyCode() {
                ...
                this.timers();
                this.$ajax.post(this.G_uri + this.ports.user.getPhoneNumberByCode,{
                    phone: phone,
                    webSite: OEMdomain
                })
                    .then(function(res) {
