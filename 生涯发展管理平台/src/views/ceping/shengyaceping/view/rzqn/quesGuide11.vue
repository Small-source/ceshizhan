<template>
    ...
    <div class="test_main test_main_2">
      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="txt_desc">
            <p>
              指导语：本测验为判断题，选择“是”“否”中与你相符的选项作答。每次显示一道题目，每题只能选择一种答案。
            </p>
            <p>要求：选择没有正误之分，所以请不要过多考虑，凭你的真实想法或感受选择。</p>

          </div>
          <div class="btngroup test_btngroup">
            <a href="javascript:;" @click="go($event)" url="/shengyaceping/rzqn/11" class="btn btn_start">开始<span
  ...
  <!--<div class="d-relative xgtz-index xgtx-ques">-->
    ...
    <!--&lt;!&ndash;<router-link class="start-ce" to="/rzqn/11"><img src="../../assets/begin2.png"></router-link>&ndash;&gt;-->
    <!--<a class="start-ce" @click="go($event)" url="/rzqn/11"><img src="../../assets/begin2.png"><span v-if="seconds">({{seconds}}s)</span></a>-->
