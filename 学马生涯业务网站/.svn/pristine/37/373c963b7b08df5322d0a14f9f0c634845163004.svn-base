<template>
    <div class="content">
        <form class="searchBox">
            <input type="text"   autocomplete="off" id='input' placeholder="搜索大学名称" v-model="subjectName"  @focus="listflag=true"  @input="search" @compositionstart="start" @compositionend="end" @keyup.enter="searchDetail('')"
                   @blur="blur" />
