    ...
    <div class="careerAnchor">
        <div class="careerAnchorBox">
            ...
            <div class="parts">
                ...
                <p>通过对您的人格特性、兴趣倾向、一般认知潜能的三方面综合分析，为您推荐匹配专业。</p>
                <ul class="list" v-if="career">
                    <li v-for="item in career">
                        <p>匹配专业</p>
                        <ul class="zhiye">
                            <li v-for="items in item"><span style="position: relative;top:-2px"></span> {{items.name}}</li>
                        </ul>
                    </li>
                </ul>
                <ul class="electiveBox" v-if="!career">
                    <li>
                        <div class="left">
                            <img src="/imgs/elective/icon_shengyaceping.png" alt="">
                        </div>
                        <div class="right">
                            <div class="title">
                                生涯测评
            ...
            <div class="parts">
                ...
                <div class="Occupation"style="padding-top: 20px">
                    <div class="shoucang">
                        <div v-for="item,key in  yuanxiaoList" style="overflow:hidden;">
                           <div class="td width">{{key}}</div>
                            <div v-for=" itemContent in item" class="td float">
                                {{itemContent.name}}
                                <div class="img" :id="itemContent.isLight==1&&'imghuang'" @click="lightStar(itemContent.id),itemContent.isLight=itemContent.isLight==1?2:1">
            ...
            <div class="parts">
                ...
                <p style="line-height:20px;padding: 24px 0 24px 40px">“决策平衡单”经常被应用于问题解决模式和职业咨询中，用以协助咨询者有系统地分析每一个可能的选项，判断分别执行各选项的利弊得失，然后依据其在利弊得失上的加权计分排定各个选项的优先顺序，以执行最优先
                    或偏好的选项。</p>
                <h3>意向专业（加权前5名）</h3>
            ...
            <div class="parts">
                ...
                <p style="line-height:20px;padding: 24px 0 24px 40px">
                    ...
                    <br>示例：在生涯测评推荐专业、收藏专业、未来名片对应专业中选择一项专业进行swot分析，我们将从内部和外部进行系统分析，内部分析是从自身的角度分析自己在从事这项专业的优势与缺陷，外部分析是从社会环境的角度分析自己在从事这项专业的机会与挑战。
                </p>
        ...
        <div class="Cards balance" v-show="balancetanchuang">
            ...
            <div class="addContent">
                <p> (1)下表中所列的是一般中学生在思考他的专业定位时考虑到的项目，希望你浏览一下这些项目。若你发现还有影响你考虑的新因素，可以添加在后面；已有的若
                    不属于你的考虑范畴,可以删除。<br>
                    (2)在决策平衡单中列出你需要进行决策的专业类型。<br>
                ...
                <div class="juece">
                    <table>
                        ...
                        <tr>
                            ...
                            <td  rowspan="2">重要度</td>
                            <td v-for="i in pinghengdan[0]&&pinghengdan[0]['l'].length" >专业{{i}}</td>
                            <td>
        ...
        <div class="Cards swotChuang" v-show="swottanchuang">
            <div class="addContent">
                <p> S代表Strengthe（优势）：清晰的知道自己在这个专业方面的优势。 <br>
                    W代表Weaknesses（缺陷）：自己在从事这个专业方面的不足，更要清晰的知道。<br>
                    O代表Opportunities（机会）：从外部因素来说哪些关键点有助于从事这项专业的成功。<br>
                ...
                <div class="swotDingwei">
                    <input type="text" v-model="swotName" id='input' placeholder="搜索专业名称" @focus="swotlistflag=true" @input="swotsearch" @compositionstart="swotstart" @compositionend="swotend" @keyup.enter="swotsearchDetail()"
                    >
                ...
                <ul class="mubiaolist">
                    ...
                    <li>
                        <div class="listDiv">
                            ...
                            <input type="text" v-model="mubiaoVlaue" id='input2' placeholder="搜索专业名称" @focus="resultlistflag=true" @input="resultsearch" @compositionstart="resultstart" @compositionend="resultend" @keyup.enter="resultsearchDetail()">
                        </div>
    ...
    export default {
        ...
        methods:{
                ...
                this.$ajax.post(this.G_uri+this.ports.careerManagement.getRecommendedProfessionAndMajor,{
                    ...
                    if(res.data.code==2000){
                        if(res.data.data.length!=0){
                            _this.career=res.data.data.majors;
                        }else{
                            _this.career=false
                        }
                    }
            ...
            saveBlanece(){
                ...
                this.$ajax.post(this.G_uri+this.ports.careerManagement.zhuanyepinghengdan.save,{
            ...
            getBlanece(){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.zhuanyepinghengdan.get,{
            ...
            getPurpose(){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.zhuanyepinghengdan.purpose,{
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
                    }
            ...
            getTongjitu(){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.zhuanyepinghengdan.tongjitu,{
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
                    }
            ...
            listSwot(){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.list,{
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
                    }
            ...
            addSwot(id){
                ...
                if(id){
                    this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.edit,{
                        id:id,
                        name:this.swotName,
                    ...
                    this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.add,{
                        name:this.swotName,
                        strengths:this.swotStrengths,
                        weaknesses:this.swotWeaknesses,
                        opportunities:this.swotOpportunities,
            ...
            delSwot(id){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.del,{
                    id:id
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
            ...
            showSwot(id){
                let _this=this;
                this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.show,{
                    id:id
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
            ...
            contrastSwot(){
                ...
                this.$ajax.post(this.G_uri+this.ports.careerManagement.swotZhuanye.duibi,{
                    ids:arr
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
            ...
            CollectionYuanxiao(){
                let _this=this
                this.$ajax.post(this.G_uri+this.ports.careerManagement.shoucang.zhuanye,{
            ...
            lightStar(id,light){
                let _this=this
                this.$ajax.post(this.G_uri+this.ports.careerManagement.shoucang.zhuanyeStar,{
                    collectionId:id
                },{
                    headers:{
                        token: window.sessionStorage.getItem('ymtxToken')
