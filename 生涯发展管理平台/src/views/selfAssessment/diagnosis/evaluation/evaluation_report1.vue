					...
					<div class="content result" id="catalog_3">
						...
						<div class="resule_table">
							...
							<!-- <table>
								...
								<tr>
									<td>掌握—趋近目标</td>
									<td>关注的是任务掌握、学习和理解；根据自己的进步和提高，以及对任务的理解深度评价自身的表现。</td>
								</tr>
								<tr>
									<td>掌握—回避目标</td>
									<td>关注如何避免不理解和没有完成任务；判断成功的标准是在自我比较基础上准确无误地完成任务。</td>
								</tr>
								<tr>
									<td>成绩—趋近目标</td>
									<td>关注如何超越他人，表现得自己最聪明、最棒；根据常模标准评价自身，如在班上考得最好。</td>
								</tr>
								<tr>
									<td>成绩—回避目标</td>
									<td>关心如何不让自己显得低能，显得比别人笨；根据常模标准来评价自身的表现，如不是班里最差的。</td>
								</tr>
							</table> -->
						</div>
