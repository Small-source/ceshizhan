...
<script>
    module.exports =  {
        ...
        methods:{
            ...
            // 辅导 - 学习习惯 养成好习惯列表
            getTableList(){
                this.$ajax.post(this.G_uri + '/careerArchives/getCoachDevelopGoodHabitsList',{
            ...
            getCardDetail(id){
                this.$ajax.post(this.G_uri + '/careerArchives/getCoachDevelopGoodHabits',{
                  studentId: this.studentId,
                	id: id
                },{
                    headers:{
            ...
            storeCardDetail(obj){
                this.$ajax.post(this.G_uri + '/careerArchives/storeCoachDevelopGoodHabits',{
                  studentId: this.studentId,
                	id: obj.id,
                	date: obj.date,
                	habit: obj.habit,
            ...
            //辅导 - 学习习惯 养成好习惯删除
            deleteTableLis(id){
                this.$ajax.post(this.G_uri + '/careerArchives/delCoachDevelopGoodHabits',{
                  studentId: this.studentId,
                	id: id,
                },{
                    headers:{
...
.Counseling9 .main_box {
  padding: 0px 20px 20px 20px;
  background-color: #fff;
  margin-bottom: 20px;
  border-radius: 5px;
}
.Counseling9 .main_box h6.title {
  line-height: 64px;
  font-size: 17px;
  color: #348DF1;
  font-weight: bolder;
...
.Counseling9 .main_box h6.title p {
  float: right;
  cursor: pointer;
  margin-top: 20px;
}
.Counseling9 .main_box .recording {
  border: 1px solid #ebebeb;
  border-radius: 5px;
  height: 132px;
}
.Counseling9 .main_box .recording .top {
  height: 90px;
  line-height: 90px;
  text-align: center;
  cursor: pointer;
...
.Counseling9 .main_box .recording .foot {
  width: 490px;
  margin: 0 auto;
  display: flex;
  justify-content: space-around;
}
.Counseling9 .main_box .recording .foot p {
  font-size: 14px;
  color: #666;
}
.Counseling9 .main_box .recording .foot p span {
  color: #358ced;
  cursor: pointer;
}
.Counseling9 .main_box .table_box ul li {
  display: flex;
}
.Counseling9 .main_box .table_box ul li .lis_box {
  display: flex;
...
.Counseling9 .main_box .table_box ul li .lis_box:nth-child(1) {
  width: 139px;
  border-left: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box ul li .lis_box:nth-child(3) {
  width: 15%;
}
.Counseling9 .main_box .table_box ul li .project_box {
  width: 45% !important;
  display: block;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box {
  display: flex;
  border-bottom: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box:last-child {
  border: none;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child {
  line-height: 24px;
  min-height: 30px;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child:nth-child(2) {
  display: flex;
  justify-content: center;
  align-items: center;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child:nth-child(3) {
  display: flex;
  justify-content: center;
  align-items: center;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .grandSon {
  width: 100%;
  display: flex;
  min-height: 40px;
  border-bottom: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .grandSon:last-child {
  border: none;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .grandSon .box {
  display: flex;
  justify-content: center;
  align-items: center;
  flex: 1;
...
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .grandSon .box:last-child {
  border: none;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child:first-child {
  width: 186px;
  border-right: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child:nth-child(2) {
...
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .duihao {
  display: block;
  width: 46px;
  height: 30px;
  cursor: pointer;
...
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .duihao:hover {
  background: url(/career/imgs/careerManagement/counseling/icon_duigoulan.png) no-repeat center;
}
.Counseling9 .main_box .table_box ul li .project_box .child_box .child .finish {
  display: block;
  width: 46px;
  height: 30px;
  cursor: pointer;
...
.Counseling9 .main_box .table_box ul li .icon {
  text-align: center;
  cursor: pointer;
}
.Counseling9 .main_box .table_box ul li .icon span {
  cursor: pointer;
...
.Counseling9 .main_box .table_box ul li .icon_edit span {
  background: url(/career/imgs/careerManagement/icon_bianjihui.png) no-repeat center center;
}
.Counseling9 .main_box .table_box ul li .icon_edit span:hover {
  background-color: #3A90F3;
}
.Counseling9 .main_box .table_box ul li .icon_del span {
  background: url(/career/imgs/careerManagement/icon_lajitonghui.png) no-repeat center center;
}
.Counseling9 .main_box .table_box ul li .icon_del span:hover {
  background-color: #FB4945;
}
.Counseling9 .main_box .table_box .table_title {
  display: flex;
  line-height: 40px;
  background-color: #f3f4f8;
  border: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box .table_title p {
  text-align: center;
  border-right: 1px solid #ebebeb;
  width: 10%;
}
.Counseling9 .main_box .table_box .table_title p:nth-child(1) {
  width: 15%;
  border-left: 1px solid #ebebeb;
}
.Counseling9 .main_box .table_box .table_title p:nth-child(5) {
  width: 15%;
}
.Counseling9 .main_box .table_box .table_title p:last-child {
  border-right: 0px;
}
.Counseling9 .main_box .detail_btn_box {
  margin-bottom: 20px;
  height: 26px;
  line-height: 26px;
}
.Counseling9 .main_box .detail_btn_box p {
  background: url(/career/imgs/careerManagement/counseling/icon.png) no-repeat 0px center;
  font-weight: 600;
  float: left;
  padding-left: 30px;
}
.Counseling9 .main_box .detail_btn_box .btn_box {
  float: right;
}
.Counseling9 .main_box .detail_btn_box .btn_box .btn {
  float: left;
  margin-left: 16px;
}
.Counseling9 .main_box .page_box {
  padding: 30px;
  display: flex;
  justify-content: center;
}
.Counseling9 .main_box .page_box span {
  line-height: 32px;
  margin-right: 10px;
}
.Counseling9 .mark {
...
.Counseling9 .mark .card .card_title {
  line-height: 60px;
  text-align: center;
  font-size: 17px;
  color: #fff;
...
.Counseling9 .mark .card .card_content {
  padding: 10px 40px;
  background-color: #fff;
  overflow-y: auto;
}
.Counseling9 .mark .card .card_content p {
  line-height: 30px;
  padding-top: 5px;
  font-size: 14px;
  font-weight: 600;
...
.Counseling9 .mark .card .card_content textarea {
...
.Counseling9 .mark .card .card_content textarea::-webkit-input-placeholder {
  color: #666;
  font-size: 12px;
}
.Counseling9 .mark .card .card_content .text_targe {
  height: 200px;
}
.Counseling9 .mark .card .card_content input {
  box-sizing: border-box;
  padding: 0px 10px;
  width: 100%;
  line-height: 40px;
...
.Counseling9 .mark .card .card_content .save {
  width: 76px;
  height: 30px;
  line-height: 30px;
  text-align: center;
...
.Counseling9 .mark .card .card_content .add_project {
  cursor: pointer;
}
.Counseling9 .mark .card .close {
  width: 17px;
  height: 17px;
  position: absolute;
  top: 21px;
