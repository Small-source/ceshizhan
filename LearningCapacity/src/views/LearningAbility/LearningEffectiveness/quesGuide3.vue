    ...
    <div class="test_main test_main_2">
      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="txt_desc">
            <p>
              指导语：本测验的任务是观察题目，从给出的选项中选出你认为正确的选项，点击确定完成作答，呈现界面切换至下一道题。
            </p>
            <p>要求：快速且准确。
</p>
            <p>注意：本测试共9题，请尽快作答。</p>
          ...
          <div class="btngroup test_btngroup">
            <a href="javascript:;" @click="go($event)" url="/learningAbility/LearningEffectiveness/3" class="btn btn_start">开始<span
