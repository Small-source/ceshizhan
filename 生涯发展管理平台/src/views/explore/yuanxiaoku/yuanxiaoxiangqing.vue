        ...
        <div class="top-university">
            ...
            <div class="xiangqingBox">
                <div class="inner">
                    ...
                    <div class="right">
                        <div class="right-Top">
                            <img :src="shoucang" alt="" @click="shouCang(cdata.id)">
                        </div>
                        <ul class="right-Bottom">
                            <li v-if="cdata.schoolNatureName">
                                <img src="/imgs/explore/yuanxiaoku/icon_gongli.png" alt="">
                                <br>
                                <span>{{cdata.schoolNatureName}}</span>
                            </li>
                            <li v-if="cdata.affiliate">
                                <img src="/imgs/explore/yuanxiaoku/icon-jiaoyubu.png" alt="">
                                <br>
                                <span>{{cdata.affiliate}}</span>
                            </li>
                            <li v-if="cdata.type">
                                <img src="/imgs/explore/yuanxiaoku/icon_zonghelei.png" alt="">
                                <br>
                                <span>{{cdata.type}}</span>
                            </li>
                            <li v-if="cdata.rank">
                                <img src="/imgs/explore/yuanxiaoku/icon_zonghepaiming.png" alt="">
                                <br>
                                <span>{{cdata.rank}}</span>
                            </li>
                            <li v-if="cdata.schoolLevelName">
                                <img src="/imgs/explore/yuanxiaoku/icon_benke.png" alt="">
                                <br>
                                <span>{{cdata.schoolLevelName}}</span>
                            </li>
                            <li v-if="cdata.masterNum">
                                <img src="/imgs/explore/yuanxiaoku/icon_shuoshidian.png" alt="">
                                <br>
                                <span>{{cdata.masterNum}}</span>
                            </li>
                            <li v-if="cdata.doctorsNum">
                                <img src="/imgs/explore/yuanxiaoku/icon_boshidian.png" alt="">
                                <br>
            ...
            <div class="right">
                ...
                <ul class="tezhong" >
                    <li @click="tezhong=true" :style="{background:tezhong?'#2D8FFC':'',color:tezhong?'#FFFFFF':''}" >
                        <img src="/imgs/explore/yuanxiaoku/te.png" alt="">
                        特色专业
                    </li>
                    <li @click="tezhong=false" :style="{background:!tezhong?'#2D8FFC':'',color:!tezhong?'#FFFFFF':''}">
                        <img src="/imgs/explore/yuanxiaoku/zhong.png" alt="">
                        重点学科
                    </li>
                </ul>
                ...
                <div class="tesezhuanye" v-if="tezhong" v-show="cdata.featureName&&cdata.featureName.length!=0">
                    <p class="xiangqing">
                        <span class="index_span" v-for="(item, index) in cdata.featureName" :key="index">
                            <router-link v-if="item.featureId" :to="'/explore/zhuanyexiangqing?id='+item.featureId+'&type=1'" class="link" target="_blank">{{item.featureName}}</router-link>
                ...
                <div class="zhongdianxueke" v-if="!tezhong" v-show="cdata.stressName&&cdata.stressName.length!=0">
                    <p class="xiangqing" id="showMores">
                        <span v-for="(item, index) in cdata.stressName" :key="index">
                            <router-link v-if="item.stressId" :to="'/explore/zhuanyexiangqing?id='+item.stressId+'&type=1'" class="link">{{item.stressName}}</router-link>
...
<style type="text/css" lang='less' scoped>
    .yuanxiaoxiangqing {
        ...
        .top-university {
            ...
            height: 254px;
            overflow: hidden;
            background: url(/imgs/explore/yuanxiaoku/banner.png) no-repeat center center;
            .xiangqingBox {
                position: relative;
                z-index: 2;
            }
            ...
            .main_box {
                .year {
                    ...
                    span {
                        ...
                        font-weight: 600;
                        color: #2c8ffc;
                        background: url('/imgs/explore/yuanxiaoku/jinazhang/icon_shijian.png') no-repeat right center;
                    }
                }
                .main {
                    font-size: 16px;
                    ...
                    .detail {
                        ...
                        .mounth {
                            ...
                            padding-right: 40px;
                            text-align: right;
                            background: url('/imgs/explore/yuanxiaoku/jinazhang/icon_yuandian.png') no-repeat 70px center;
                        }
                        .title {
                            padding-left: 24px;
                            width: 400px;
                        ...
                        .type {
                            width: 200px;
                            padding-left: 30px;
                            background: url('/imgs/explore/yuanxiaoku/jinazhang/icon_jianzhangleixing.png') no-repeat 5px center;
                        }
                        .provance {
                            padding-left: 30px;
                            background: url('/imgs/explore/yuanxiaoku/jinazhang/icon_dingwei.png') no-repeat 5px center;
                        }
                    }
                }
            }
...
export default {
    ...
    data() {
        return {
            ...
            sceneryIndex: 0,
            sceneryStyle: 0,
            shoucang:'/imgs/explore/yuanxiaoku/icon_shoucang.png'
        }
    },
    computed: {
        tese() {
    ...
    methods: {
        ...
        showMoreYuanxiao(){
            if(this.showMoreText){
                $('.yuanxiaojianjie .xiangqing').css({maxHeight:'500px',marginBottom:'50px'})
                ...
                .then(function(res) {
                    if(res.data.code == 2000) {
                        if(res.data.data.id==true){
                            if(_this.shoucang=='/imgs/explore/yuanxiaoku/icon_shoucang.png'){
                                _this.shoucang='/imgs/explore/yuanxiaoku/icon_shoucangdianliang.png'
                            }else{
                                _this.shoucang='/imgs/explore/yuanxiaoku/icon_shoucang.png'
                            }
                        }
                    }else if(res.data.code == 1016) {
                        _this.$router.push('/login')
