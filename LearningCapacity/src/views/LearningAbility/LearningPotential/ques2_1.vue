...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      answerClick: function (e) {
        ...
        if (this.expandNumber == '') {
          ...
          if (this.type == 'test' && this.answerCount == 3) {
            this.$router.push('/learningAbility/learningPotential/success/21?type=test')
          }
        }
        var obj = {};
      ...
      submit: function () {
          let _this=this;
        this.$ajax.post(this.G_uri+"/result/cognition/worka/add", {
            time: this.time,
          ...
          function (res) {
            ...
            if (data.code == 0) {
              _this.saveNode(1, 22);
              _this.$router.push('/learningAbility/learningPotential/success/21')
            } else {
