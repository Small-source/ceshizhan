    ...
    if (monthData.length > 0) {
      monthData.forEach((item,index) => {
        if(index==0){
          ...
          _this.setData({
            w1:_this.data.one1/_this.data.one2*100+'%',
            w2: _this.data.two1 / _this.data.two2 * 100 + '%',
            w3: _this.data.three1 / _this.data.three2 * 100 + '%',
            w4: _this.data.four1 / _this.data.four2 * 100 + '%'
          })
        }
