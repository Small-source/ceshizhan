...
<style type="text/css" lang='less' scoped>
    .zhuanyexiangqing {
        ...
        .header {
            height: 140px;
            color: #333;
            background: url(/imgs/elective/majorSelectedSubjects/bg_xiangqing.png) no-repeat center center;
            .inner {
                position: relative;
                overflow: hidden;
                padding-top: 40px;
            ...
            .goBack {
                ...
                height: 32px;
                line-height: 26px;
                background: url(/imgs/elective/majorSelectedSubjects/icon_goback.png) no-repeat center center;
                text-align: center;
                font-size: 12px;
                border-radius: 2px;
                top: 40px;
            ...
            .top_title {
                ...
                .imgBox {
                    ...
                    background: url(/imgs/elective/majorSelectedSubjects/icon_gongjuxiang.png) no-repeat center center;
                }
                .main {
                    float: left;
                    padding-left: 20px;
