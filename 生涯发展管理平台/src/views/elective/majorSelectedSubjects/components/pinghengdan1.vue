<template>
    ...
    <div class="pinghengdan1">
        ...
        <!-- 底部按钮 -->
        <div class="ft_btns">
            <div class="ft_btn go_pre" @click="$router.push('/elective/majorSelectedSubjects/xuekeyaoqiu')">上一步</div>
            <div @click="$router.push('/elective/majorSelectedSubjects/pinghengdan2')" class="ft_btn go_next)">下一步</div>
        </div>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            state: 1,
            page: '',
            src1:'/imgs/elective/majorSelectedSubjects/icon_stars2.png',
            src2:'/imgs/elective/majorSelectedSubjects/icon_stars1.gif',
