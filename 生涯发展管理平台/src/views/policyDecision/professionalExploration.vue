    ...
    <div class="universityExploration">
        ...
        <div class="parts" style="padding-bottom: 30px">
            ...
            <form action="">
                <div class="inputs">
                    <span>专业:</span>
                    <input type="text" id='input' placeholder="搜索专业名称" v-model="subjectName"  @focus="listflag=true"  @input="search" autocomplete="off"  @compositionstart="start" @compositionend="end" @keyup.enter="searchDetail('')"
                ...
                <div class="inputs">
                    <span>专业大类:</span>
                    <el-input type="text" v-model="zhuanyedalei" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>年限:</span>
                    <el-input type="text" v-model="nianxian" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>学位:</span>
                    <el-input type="text" v-model="xuewei" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>主要课程:</span>
                    <el-input type="text" v-model="zhuyaokecheng" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>相近专业:</span>
                    <el-input type="text" v-model="xiangjinzhuanye" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>就业方向:</span>
                    <el-input type="text" v-model="jiuyefangxiang" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>考研方向:</span>
                    <el-input type="text" v-model="kaoyanfangxiang" :disabled="editFlag">
                    </el-input>
                </div>
                <div class="inputs">
                    <span>对应院校:</span>
                    <el-input type="text" v-model="duiyingyuanxiao" :disabled="editFlag">
                    </el-input>
                </div>
            </form>
    ...
    export default {
        ...
        methods:{
            ...
            search(){
                if(this.flag){
                    let _this=this;
                    this.$ajax.post(this.G_uri +this.ports.expore.majorFive, {
            ...
            list(number){
                let _this=this
                this.$ajax.post(this.G_uri +this.ports.expore.majorList, {
                    pageNumber: number||1,
                    pageSize:5
                }, {
                    headers:{
            ...
            save(id){
                ...
                //     return;
                // }
                this.$ajax.post(this.G_uri +this.ports.expore.majorAddEidt, {
                    subjectName:this.subjectName,
                    subjectCate:this.zhuanyedalei,
                    year:this.nianxian,
                    degree:this.xuewei,
                    majorCourse:this.zhuyaokecheng,
                    similarMajor:this.xiangjinzhuanye,
                    employmentDirection:this.jiuyefangxiang,
                    postgraduateOrientation:this.kaoyanfangxiang,
                    correspondUniversity:this.duiyingyuanxiao,
                    id:this.nowId||''
                }, {
                    headers:{
                        token:window.sessionStorage.getItem('ymtxToken')
            ...
            del(id){
                ...
                this.$ajax.post(this.G_uri +this.ports.expore.majorDel, {
                    id:id||this.nowId
                }, {
                    headers:{
                        token:window.sessionStorage.getItem('ymtxToken')
            ...
            show(id,flag){
                ...
                this.nowId=id
                this.$ajax.post(this.G_uri +this.ports.expore.majorDetial, {
                    id:id
                }, {
                    headers:{
                        token:window.sessionStorage.getItem('ymtxToken')
                    ...
                    if(res.data.code==2000) {
                        ...
                        this.zhuanyedalei=data.subjectCate
                        this.nianxian=data.year
                        this.xuewei=data.degree
                        this.zhuyaokecheng=data.majorCourse
                        this.xiangjinzhuanye=data.similarMajor
                        this.jiuyefangxiang=data.employmentDirection
                        this.kaoyanfangxiang=data.postgraduateOrientation
                        this.duiyingyuanxiao=data.correspondUniversity
                    }
                })
            },
            clear(){
                ...
                this.xuewei=""
                this.zhuyaokecheng=""
                this.xiangjinzhuanye=""
                this.jiuyefangxiang=""
                this.kaoyanfangxiang=""
                this.duiyingyuanxiao=""
                this.nowId=""
                this.oldId=""
            },
            //删除确认
            delConfirm(id){
                if(this.subjectName==""&&this.zhuanyedalei==""&&this.nianxian==""&&this.xuewei==""&&this.zhuyaokecheng==""){
                    if(this.xiangjinzhuanye==""&&this.jiuyefangxiang==""&&this.kaoyanfangxiang==""&&this.duiyingyuanxiao==""){
                        this.del(id)
                        return;
                    }
                }
