    ...
    <div class="jihuoka">
        <div class="mark">
            <div class="tanchuang1" v-show="!isJihuo">
                <p class="title">激活自招综评复试卡</p>

                <p class="neirong">
                    <input type="text" v-model="KaNumber" placeholder="请输入自招综评复试卡账号" class="Username"  onfocus="this.placeholder=''" onblur="this.placeholder='请输入自招综评复试卡账号'"  >
                </p>
                <!-- <p class="warning">{{warning1}}</p> -->
                <p class="neirong2">
                    <input type="password" v-model="Kapassword" placeholder="请输入自招综评复试卡密码" class="Password1"  onfocus="this.placeholder=''" onblur="this.placeholder='请输入自招综评复试卡密码'" >
                </p>
