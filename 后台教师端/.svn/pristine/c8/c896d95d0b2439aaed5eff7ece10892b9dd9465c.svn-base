...
<script>
    module.exports = {
        ...
        methods:{
            ...
            getCardDetail(id){
                this.$ajax.post(this.G_uri + '/careerArchives/getCoachSundayAssessment',{
                    studentId: this.studentId,
                	id: id
                },{
                    headers:{
            ...
            storeCardDetail(obj){
                this.$ajax.post(this.G_uri + '/careerArchives/storeCoachSundayAssessment',{
                    studentId: this.studentId,
                	id: obj.id,
            ...
            deleteTableLis(id){
                this.$ajax.post(this.G_uri + '/careerArchives/delCoachSundayAssessment',{
                    studentId: this.studentId,
                	id: id,
                },{
                    headers:{
            ...
            //辅导 - 学习习惯 周日评估表列表
            getTableList(){
                this.$ajax.post(this.G_uri + '/careerArchives/getCoachSundayAssessmentList',{
                    studentId: this.studentId,
                	pageNumber: this.pageNumber,
                    pageSize: this.pageSize,
                },{
