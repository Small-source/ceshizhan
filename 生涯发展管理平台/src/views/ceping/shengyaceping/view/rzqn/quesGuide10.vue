<template>
    ...
    <div class="test_main test_main_2">
      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="txt_desc">
            <p>
              指导语：本测验的任务是观察题目，请您根据你自己的实际情况，在A B C D选项中作出选择。每次显示一道题目，每题只能选择一种答案。作答时间没有限制，请认真作答。
            </p>
            <p>要求：选择没有正误之分，所以请不要过多考虑，凭你的真实想法或感受选择。</p>

          </div>
          <div class="btngroup test_btngroup">
            <a href="javascript:;" @click="go($event)" url="/shengyaceping/rzqn/10" class="btn btn_start">开始<span
  ...
  <!--<div class="d-relative xgtz-index xgtx-ques">-->
    ...
    <!--&lt;!&ndash;<router-link class="start-ce" to="/rzqn/10"><img src="../../assets/begin2.png"></router-link>&ndash;&gt;-->
    <!--<a class="start-ce" @click="go($event)" url="/rzqn/10"><img src="../../assets/begin2.png"><span v-if="seconds">({{seconds}}s)</span></a>-->
