<template>
    <div class="xuekeyaoqius">
            ...
            <div class="content">
                ...
                <div class="readProtocol" v-if="cdata">
                    ...
                    <div class="neirongBox1">
                        <div class="details">
                           <!-- <p class="detail_top">认真分析以上目标专业的学科要求，同一专业在不同院校选科要求也有差异，你的选考科目是你能够报考该专业的基础。</p> -->
        ...
        <div class="ft_btns" v-if="cdata">
            <div class="ft_btn go_pre"  @click="$router.push('/zhinengxuanke/mubiaozhuanye2')">上一步</div>
        ...
        <div class="loading"  v-show="!cdata">
            <Loading></Loading>
        </div>
    </div>
</template>
...
.xuekeyaoqius {
                ...
                li {
                    ...
                    .main {
                        ...
                        .main_num {
                            ...
                            .num_active {
                                width: 20px;
                                background: url(/imgs/xingaokao/xuankejuece/common/icon_shouqi.png) no-repeat center center;
                            }
                            .num_unactive {
                                width: 20px;
                                background: url(/imgs/xingaokao/xuankejuece/common/icon_xiala.png) no-repeat center center;
                            }
                        }
                ...
                .isAgree {
                    ...
                    .unjumpOver {
                        ...
                        .box {
                            ...
                            line-height: 18px;
                            background-color: #fff;
                            background: url(/imgs/xingaokao/xuankejuece/common/icon_unchecked.png) no-repeat center center;
                        }
                        .names {
                            float: right;
                            line-height: 18px;
                    ...
                    .jumpOver {
                        .unjumpOver;
                       .box {
                             background: url(/imgs/xingaokao/xuankejuece/common/icon_checked.png) no-repeat center center;
                        }
    ...
    .tixing {
        ...
        .tanchuang {
            ...
            left: 50%;
            margin-left: -152px;
            background: url(/imgs/xingaokao/xuankejuece/360xuanke/bg_tishitanchuang.png) no-repeat center center;
...
export default {
    ...
    data() {
        return { 
            ...
            // 防止选3科连续点击|
            isClick: true,
            // target_major: this.$route.params.mubiaozhuanye,
    ...
    methods: {
        ...
        getTargetProfession() {
            ...
            if(this.$route.params.mubiaozhuanye) {
                ...
                window.sessionStorage.setItem("mubiaozhuanye",JSON.stringify(subject));
            }else {   
                subject =JSON.parse(window.sessionStorage.getItem("mubiaozhuanye"));
            }
            this.$ajax
        ...
        goNext() {
            ...
            window.sessionStorage.setItem("subjectSets",JSON.stringify(subjectSets));
            if(this.isShowAgree) {
                if(subjectSets.length < 3 && subjectSets.length > 0) {
                    // console.log(subjectSets.length)
                    this.$router.push('/zhinengxuanke/pinghengdan1');
    ...
    watch: {
        $route(to,from){
            if(from.name == 'mubiaozhuanye2') {
                this.mubiaozhuanye_1 = JSON.parse(window.sessionStorage.getItem('mubiaozhuanye_1'));
                this.mubiaozhuanye_2 = JSON.parse(window.sessionStorage.getItem('mubiaozhuanye_2'));
