...
Page({
  ...
  getReportId(){
    HTTP.post(GET_USER_INFO, {})
      .then((res) => {
        this.setData({
          reportId: res.data.applet_serial_report_id
        })
        this.detail(res.data.applet_serial_report_id);
        this.detail2(res.data.applet_serial_report_id);
        this.detail3(res.data.applet_serial_report_id);
        this.detail4(res.data.applet_serial_report_id);
        this.detail5(res.data.applet_serial_report_id);
      })
  },
  //报告接口1
  detail(id){
