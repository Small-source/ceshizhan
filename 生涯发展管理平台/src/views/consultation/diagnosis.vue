    ...
    <div class="diagnosis" v-cloak>
        ...
        <div class="main_box">     
	        <div class="evaluation">
	            ...
	            <ul class="lis_box">
	                <router-link tag="li" :to="'/selfAssessment/diagnosis/evaluation_entry?question=' + item.id" v-for="(item, index) in evaluation" :key="index" class="lis">
	                    <div class="img_box">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goReport(type,id) {
                let url = '/selfAssessment/diagnosis/evaluationReport' + type;
