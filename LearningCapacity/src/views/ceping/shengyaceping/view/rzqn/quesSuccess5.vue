    ...
    <div class="test_main test_main_2">
      ...
      <div class="test_detail test_3">
        <div class="box">
          ...
          <div class="btngroup">
            <router-link class="btn btn_goon" v-if="type!='test'" to="/shengyaceping/rzqn/instru/6">点击继续</router-link>
            <router-link v-if="type=='test'" to="/shengyaceping/rzqn/5?type=test" class="btn btn_jx">继续练习</router-link>
            <router-link v-if="type=='test'" to="/shengyaceping/rzqn/guide/5" class="btn btn_start">完成练习</router-link>
          </div>
        </div>
      </div>
    </div>
