<template>
      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="btngroup test_btngroup">
            <a href="javascript:;" @click="go($event)" url="/learningAbility/learningPotential/8" class="btn btn_start">开始<span
  ...
  <!--<div class="d-relative xgtz-index xgtx-ques">-->
    ...
    <!--&lt;!&ndash;<router-link class="start-ce" to="/rzqn/8"><img src="../../assets/begin2.png"></router-link>&ndash;&gt;-->
    <!--<a class="start-ce" @click="go($event)" url="/rzqn/8"><img src="../../assets/begin2.png"><span v-if="seconds">({{seconds}}s)</span></a>-->
