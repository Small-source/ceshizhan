<template>
    <div class="careerAnchor">
                ...
                <ul class="electiveBox">
                    <li>
                        ...
                        <div class="right">
                            ...
                            <div class="button">
                                 <router-link to="/careerManagement/matchingSchools">
                                    查看
                                </router-link>
                            </div>
                        </div>
        ...
        <div class="Cards balance" v-show="balancetanchuang">
            ...
            <div class="addContent">
                <p> (1)下表中所列的是一般中学生在思考他的院校定位时考虑到的项目，希望你浏览一下这些项目。若你发现还有影响你考虑的新因素，可以添加在后面；已有的若
                    不属于你的考虑范畴,可以删除。<br>
                    (2)在决策平衡单中列出你需要进行决策的院校类型。<br>
                    (3)尊重你内心的意愿,逐一检视各个选项,并以"-2"至"2"的五点量表(-2,-1,0,1,2)来赋分。<br>
                    (4)重要考虑因素的赋分还可乘以1~5倍加权计分。<br>
                    (5)根据各院校加权计分的总分结果确定你的院校目标。
                </p>
                <div class="juece">
                    <table>
                        <thead>
                        <tr>
                            ...
                            <td  rowspan="2">重要度</td>
                            <td v-for="i in pinghengdan[0]&&pinghengdan[0]['l'].length" >院校{{i}}</td>
                            <td>
        ...
        <div class="Cards swotChuang" v-show="swottanchuang">
            <div class="addContent">
                <p> S代表Strengthe（优势）：清晰的知道自己在这个院校方面的优势。 <br>
                    W代表Weaknesses（缺陷）：自己在从事这个院校方面的不足，更要清晰的知道。<br>
                    O代表Opportunities（机会）：从外部因素来说哪些关键点有助于从事这项院校的成功。<br>
                    T代表Threats（挑战）：从外部因素分析自己从事这项院校的挑战与威胁。
                </p>
                <div class="title">
                    <span>*</span>添加分析对象
                </div>
