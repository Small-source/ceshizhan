      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="txt_desc">
            <p>
                注意稳定性——视觉追踪测评
                本测评是一个视力追踪测评。要求您用眼睛从左侧开始追踪一条曲线，并将该线起始时的序号，用键盘上的数字标记在右侧曲线结束的方格内。如下图: <br>
          ...
          <div class="btngroup test_btngroup">
              <router-link to="/learningAbility/learningPotential/93?type=test" class="btn btn_jx">练习</router-link>
            <a href="javascript:;" @click="go($event)" url="/learningAbility/learningPotential/93" class="btn btn_start">开始<span
