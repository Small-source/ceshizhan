      ...
      <div class="test_detail test_1">
        <div class="radio_box">
          ...
          <div class="btngroup test_btngroup">
            <router-link to="/learningAbility/learningPotential/play/3" class="btn btn_jx">演示</router-link>
            <router-link to="/learningAbility/learningPotential/3?&type=test" class="btn btn_jx">练习</router-link>
            <a href="javascript:;" @click="go($event)" url="/learningAbility/learningPotential/3?seq=1" class="btn btn_start">开始<span
