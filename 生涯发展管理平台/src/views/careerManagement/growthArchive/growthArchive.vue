<template>
	<div class="evaluation_report">
			...
			<div class="page_shadow">
				<div class="page pdf-page">
					...
					<div class="content" id="catalog_1">
						<div class="big_title_box" @click="scrollToView('jianjie')">
							<div class="big_title"><span>Part1</span>简介</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('fangtan')">
							<p class="big_title"><span>Part2</span>初步访谈</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('result')">
							<p class="big_title"><span>Part3</span>测评结果</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('assessReport1')">
							<div class="small_title">成就目标定向测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box">
							<div class="small_title" @click="scrollToView('assessReport2')">时间管理测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box">
							<div class="small_title" @click="scrollToView('assessReport3')">学习动机测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box">
							<div class="small_title" @click="scrollToView('assessReport4')">学习习惯测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box">
							<div class="small_title" @click="scrollToView('assessReport5')">情绪管理测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box">
							<div class="small_title" @click="scrollToView('assessReport6')">人际关系综合诊断测评</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('pinggu')">
							<p class="big_title"><span>Part4</span>评估与诊断</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('mubiao')">
							<p class="big_title"><span>Part5</span>咨询目标</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('fangan')">
							<p class="big_title"><span>Part6</span>咨询方案</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('jilu')">
							<p class="big_title"><span>Part7</span>咨询记录</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="big_title_box" @click="scrollToView('fudao')">
							<p class="big_title"><span>Part8</span>辅导</p>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('dongji')">
							<div class="small_title">学习动机</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('xiguan')">
							<div class="small_title">学习习惯</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('nengli')">
							<div class="small_title">学习能力</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('guanli')">
							<div class="small_title">情绪管理</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
						<div class="small_title_box" @click="scrollToView('guanxi')">
							<div class="small_title">人际关系</div>
							<div class="line"></div>
							<div class="page_number"></div>
						</div>
					</div>
		...
		<div class="pdfs" id="pdfDom" style="background-color:#E8E8E8;" v-if="!isDownloading">
			<div class="page_shadow">
				<div class="page pdf-page">
					<div class="page_content" v-if="firstInterview && firstInterview.constructor == Object">
						<h5 class="header" id="fangtan">
							<span></span>初步访谈
						</h5>
	                ...
	                <div class="page_content" v-if="assessReport1 && assessReport1.constructor == Object">
						<h5 class="header" id="result">
	                        <span></span>测评结果
	                    </h5>
	                    <div class="content">
	                        <h6 class="report_header" id="assessReport1">成就目标定向测评</h6>
					...
					<div class="page_content"  v-if="assessReport2 && assessReport2.constructor == Object">

	                    <div class="content result" id="catalog_3">
	                        <h6 class="report_header" id="assessReport2">时间管理测评</h6>
	                        ...
	                        <p class="completion" v-if="false">
	                            您的<strong>总平均</strong>分为<span>{{assessReport2.studentData.avgScore}}</span>分，这说明<span>{{assessReport2.studentData.content}}</span>
	                        </p>
					...
					<div class="page_content">
	                    <div class="content" v-if="assessReport3 && assessReport3.constructor == Object">
	                        <h6 class="report_header" id="assessReport3">学习动机测评</h6>
	                        <div class="echarts_box">
	                        ...
	                        <div class="resule_table">
	                            <ul>
	                                <li v-for="(value, key, index) in assessReport3.studentData.list" :key="index">
					...
					<div class="page_content">
	                    <div class="content" v-if="assessReport4 && assessReport4.constructor == Object">
	                        <h6 class="report_header" id="assessReport4">学习习惯测评</h6>
	                        <p class="circle_title">通过对您的作答结果进行分析，您当前的得分如下图所示(每项满分为5分)：</p>
	                        <div class="circle_box">
					...
					<div class="page_content">
	                    <div class="content" v-if="assessReport5 && assessReport5.constructor == Object"  style="height:1100px;">
	                        <h6 class="report_header" id="assessReport5">情绪管理测评</h6>
					...
					<div class="page_content">
	                    <div class="content"  v-if="assessReport6 && assessReport6.constructor == Object">
	                        <h6 class="report_header" id="assessReport6">人际关系综合诊断测评</h6>
	                        <div class="resule_table">
					...
					<div class="page_content" v-if="assessmentInfo && assessmentInfo.constructor == Object">
						<h5 class="header" id="pinggu">
	                        <span></span>评估与诊断
	                    </h5>
	                    <div class="content">
					...
					<div class="page_content" v-if="planConsultTarget && planConsultTarget.constructor == Object">
						<h5 class="header" id="mubiao">
	                        <span></span>咨询目标
	                    </h5>
	                    <div class="content">
					...
					<div class="page_content"  v-if="planConsultScheme && planConsultScheme.constructor == Object">
						<h5 class="header" id="fangan">
	                        <span></span>咨询方案
	                    </h5>
	                    <div class="content">
					...
					<div class="page_content" v-if="planConsultInfo && planConsultInfo.constructor == Object">
						 <h5 class="header" id="jilu">
	                        <span></span>咨询记录
	                    </h5>
	                    <div class="content">
					...
					<div class="page_content" v-if="planConsultLog.length">
                        <div class="history_box">
                            <p class="title">历史咨询记录</p>
                            <table>
                                <tr>
                                ...
                                <tr v-for="(item, index) in planConsultLog">
                                    <td>{{item.theme}}</td>
					...
					<div class="page_content" v-if="coach && coach.constructor == Object">
						<h5 class="header" id="fudao">
	                        <span></span>辅导
	                    </h5>
					</div>	


					<div class="page_content"  v-if="intensiveTraining.length||(planConsultScheme && planConsultScheme.constructor == Object) ||selfMotivation.length||attributionAssess.length||(attribution && attribution.constructor == Object)">
                        <h6 class="report_header" id="dongji">
                            学习动机
                        </h6>
					</div>

					<div class="page_content" v-if="intensiveTraining.length" v-for="(item, index) in intensiveTraining" :key="item.id">
	                    <div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>强化训练</p>
	                        <div class="report_mained" >
	                            <div class="mained_block"></div>
	                            <div class="box">
					...
					<div class="page_content"  v-if="planConsultScheme && planConsultScheme.constructor == Object">
	                    <div class="content">
	                        <p class="mained_title"><span></span>自我激励训练</p>
	                        <div class="report_mained" >
	                            <div class="box_jili">
					...
					<div class="page_content"  v-if="selfMotivation.length">
						<div class="history_box" >
                            <table>
                                <tr>
                                    <th>激励领域</th>
					...
					<div class="page_content" v-if="attribution && attribution.constructor == Object">
	                    <div class="content">
	                        <p class="mained_title"><span></span>归因训练</p>
					...
					<div class="page_content" v-if="attributionAssess.length">
                    	<p class="mained_title"><span></span>咨询师评估</p>
					...
					<div class="page_content"  v-if="previewBeforeClass.length||reviewAfterClass.length||(primeTime && primeTime.constructor == Object)">
						<h6 class="report_header" id="xiguan">
                            学习习惯
                        </h6>
					</div>	
					...
					<div class="page_content"  v-if="previewBeforeClass.length" v-for="(item, index) in previewBeforeClass">
						<div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>课前预习--小作业</p>
	                        <div class="report_mained">
	                            <div class="mained_block"></div>
	                            <div class="box">
	                                <p class="task">
	                                ...
	                                <div class="finish" v-for="(project) in item.project">
					...
					<div class="page_content"  v-if="reviewAfterClass.length"  v-for="(item, index) in reviewAfterClass">
						<div class="content">
							<p class="mained_title" v-show="index == 0"><span></span>课后复习--小作业</p>
	                        <div class="report_mained">
	                            <div class="mained_block"></div>
	                            <div class="box">
	                                <p class="task">
					...
					<div class="page_content" v-if="primeTime && primeTime.constructor == Object">
						<div class="content">
	                        <p class="mained_title"><span></span>发现黄金时间</p>
	                        <div class="lis_time">
	                            <ul>
	                                <li>
					...
					<div class="page_content habbit" v-for="(item, index) in developGoodHabits" v-if="developGoodHabits.length">
						<div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>养成好习惯</p>
	                        <div class="report_mained">
	                            <div class="mained_block"></div>
	                            <div class="box">
	                                <p class="task">
	                                    ...
	                                    <span>小目标：{{item.alreadyDate}}</span>
	                                </p>
	                                <div v-for="(detail, $idx) in item.detail">
					...
					<div class="page_content" v-for="(item, index) in learnMemory" v-if="learnMemory.length">
						<div class="content">
	                        <h6 class="report_header" v-show="index == 0" id="nengli">
	                            学习能力
	                        </h6>
	                        <p class="mained_title" v-show="index == 0"><span></span>记忆力训练</p>
	                        <div class="report_mained">
	                            <div class="box">
					...
					<div class="page_content" v-if="moodSelfAwareness.length||moodDialogue.lwngth||moodWithAbc.length">
						<h6 class="report_header" id="guanli">
                            情绪管理
                        </h6>
					</div>		
					<div class="page_content"  v-for="(item, index) in moodSelfAwareness"  v-if="moodSelfAwareness.length">
	                    <div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>自我觉察应用表</p>
	                        <div class="report_mained">
	                            <div class="box">
	                                <p class="title">事件：</p>
					...
					<div class="page_content" v-for="(item, index) in moodDialogue" v-if="moodDialogue.length">
						<div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>练习和情绪对话</p>
	                        <div class="report_mained" >
	                            <div class="box">
	                                <p class="title">内容：</p>
	                                <p class="detail">{{item.content}}</p>
					...
					<div class="page_content" v-for="(item, index) in moodWithAbc" v-if="moodWithAbc.length">
						<div class="content">
	                        <p class="mained_title" v-show="index == 0"><span></span>用ABC理论管理情绪的计划</p>
	                        <div class="report_mained" >
	                            <div class="box">
					...
					<div class="page_content" v-for="(item, index) in interpersonal"  v-if="interpersonal.length">
                        <h6 class="report_header" v-show="index == 0" id="guanxi">
                            人际关系
                        </h6>
                        <p class="mained_title" v-show="index == 0"><span></span>咨询师记录</p>
                        <div class="report_mained">
                            <div class="box">
	...
	* {
	...
	.pdf {
		...
		.page_cover {
			height: 1230px;
			padding-top: 70px;
			background: url(/imgs/careerManagement/growthArchive/page_growthArchive.png);
...
export default {
    ...
    methods: {
        ...
        countPage() {
        	...
        	let html2 = '</div></div>';
        	let allHtml = '<div class="page_shadow"><div class="page pdf-page"><p class="big_page_number">第2页</p>';
        	let pageNumber = 2;
        	let height = 1170;
        	...
        	$('.page_content').each(function() {
        		...
        		if(page_content_height <= height) {
        			...
        			pageNumber ++;
        			let elPageNumber = '<p class="big_page_number">第' + pageNumber + '页</p>';
        			page_content_height = nowHeight
    ...
    watch: {
    	reportData() {
    		this.htmlTitle = this.reportData.studentInfo.s.n + '的成长档案'
    	...
    	assessReport1() {
    		if(this.assessReport1 && this.assessReport1.constructor == Object) {
	    		let el = 'echarts1';
	    		let aver = 'average';
    	...
    	assessReport2() {
    		if(this.assessReport2 && this.assessReport2.constructor == Object) {
	    		let el1 = 'echarts2_1';
	    		let el2 = 'echarts2_2';
	    		let el3 = 'echarts2_3';
	    		let aver = 'avgScore';
    	...
    	assessReport3() {
    		if(this.assessReport3 && this.assessReport3.constructor == Object) {
	    		let el = 'echarts3';
	    		let aver = 'score';
    	...
    	assessReport4() {
    		if(this.assessReport4 && this.assessReport4.constructor == Object) {
	    		this.$nextTick(() => {
					this.setCircle4();
				})
			}
    	...
    	assessReport5() {
    		if(this.assessReport5 && this.assessReport5.constructor == Object) {
	    		this.$nextTick(() => {
					this.setCircle5();
				})
			}
