      ...
      <div class="test_detail test_3">
        <div class="box">
          ...
          <div class="btngroup">
            ...
            <router-link v-if="type=='test'" class="btn btn_jx" to="/learningAbility/learningPotential/3?type=test">继续练习</router-link>
            <router-link v-if="type=='test'" class="btn btn_start" to="/learningAbility/learningPotential/guide/3"
...
<script>
  ...
  export default {
    ...
    methods: {
      go: function () {
        if (this.seq == 6) {
          this.$router.push('/learningAbility/learningPotential/instru/4')
        } else {
          this.seq = Number(this.seq) + 1;
          this.$router.push('/learningAbility/learningPotential/3?seq=' + this.seq);
        }
      },

      goTest: function () {
        if (this.seq == 4) {
          this.$router.push('/learningAbility/learningPotential/guide/3')
        } else {
          this.seq = Number(this.seq) + 1;
          this.$router.push('/learningAbility/learningPotential/3?seq=' + this.seq + '&type=test');
        }
      },
    }
  }
