                    ...
                    <div class="ques-answer">
                        <div class="zhuti zhuti_test">
                            <div class="content_box_test">
                                <!-- <img src="~@/assets/newceping/rzqntest144.png" alt=""> -->
    ...
    methods: {
       ...
       */
        submit: function () {
            ...
            if(this.type=='test'){
                this.$router.push('/shengyaceping/rzqn/success/144?type=test');
            ...
            this.$ajax.post(this.G_uri + "/result/cognition/attentiond/compute", {
                ...
                {
                    headers: {
                      "token": sessionStorage.getItem('ymtxToken'),
                    }
                },
                {
                    emulateJSON: true
                    ...
                    function (res) {
                        ...
                        var data = res.data;
                        if (data.code == 0) {
                            _this.$router.push('/shengyaceping/rzqn/success/144')
                        } else {
...
<style lang='less'>
  .zhuyiliceping4{
    ...
    .content_box {
      ...
      background: url("~@/assets/newceping/rzqn144.png") no-repeat center center;
    ...
    .content_box_test {
        ...
        height: 124px;
        padding: 24px;
        background: url("~@/assets/newceping/rzqntest144.png") no-repeat center center;
        background-size: 100% 100%;
        display: flex;
        flex-wrap: wrap;
        .input_box {
