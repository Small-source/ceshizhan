// 新高考生涯测评
const Shengyaceping = () => import('../views/ceping/shengyaceping/shengyaceping.vue');
//主页面
const EvluaClassify = () => import('../views/ceping/shengyaceping/view/evlua/classify.vue');
...
// 认知潜能
const RzqnIndex = () => import('../views/ceping/shengyaceping/view/rzqn/index.vue');
const RzqnQuesOne = () => import('../views/ceping/shengyaceping/view/rzqn/ques1');
const RzqnQues21 = () => import('../views/ceping/shengyaceping/view/rzqn/ques21');
const RzqnQues22 = () => import('../views/ceping/shengyaceping/view/rzqn/ques22');
const RzqnQues3 = () => import('../views/ceping/shengyaceping/view/rzqn/ques3');
...
const RzqnQues144 = () => import('../views/ceping/shengyaceping/view/rzqn/ques144')
...
const RzqnGuide3 = () => import('../views/ceping/shengyaceping/view/rzqn/quesGuide3')
const RzqnPlay3 = () => import('../views/ceping/shengyaceping/view/rzqn/quesPlay3')
...
const RzqnGuide144 = () => import('../views/ceping/shengyaceping/view/rzqn/quesGuide144')
...
const RzqnSuccess3 = () => import('../views/ceping/shengyaceping/view/rzqn/quesSuccess3')
...
const RzqnSuccess144 = () => import('../views/ceping/shengyaceping/view/rzqn/quesSuccess144')
//性格特性
...
const quesGuide1 = () => import('../views/ceping/shengyaceping/view/xgtx/quesGuide1')
const quesGuide2 = () => import('../views/ceping/shengyaceping/view/xgtx/quesGuide2')
const quesSuccess1 = () => import('../views/ceping/shengyaceping/view/xgtx/quesSuccess1')
const quesSuccess2 = () => import('../views/ceping/shengyaceping/view/xgtx/quesSuccess2')
const quesTwo = () => import('../views/ceping/shengyaceping/view/xgtx/quesTwo')
//心理健康
const XljkIndex = () => import('../views/ceping/shengyaceping/view/xljk')
const XljkGuide = () => import('../views/ceping/shengyaceping/view/xljk/quesGuide')
const xljkQuesOne = () => import('../views/ceping/shengyaceping/view/xljk/quesOne')
const xljkQuesSuccess = () => import('../views/ceping/shengyaceping/view/xljk/quesSuccess')
//兴趣倾向
const XqqxIndex = () => import('../views/ceping/shengyaceping/view/xqqx')
const XkcjIndex = () => import('../views/ceping/shengyaceping/view/xqqx/index2')
const XqqxQuesOne = () => import('../views/ceping/shengyaceping/view/xqqx/ques1')
const XqqxQuesTwo = () => import('../views/ceping/shengyaceping/view/xqqx/ques2')
const XqqxQuesThree = () => import('../views/ceping/shengyaceping/view/xqqx/ques3')
const XqqxQuesFour = () => import('../views/ceping/shengyaceping/view/xqqx/ques4')
const XqqxGuide1 = () => import('../views/ceping/shengyaceping/view/xqqx/quesGuide1')
const XqqxGuide2 = () => import('../views/ceping/shengyaceping/view/xqqx/quesGuide2')
const XqqxGuide3 = () => import('../views/ceping/shengyaceping/view/xqqx/quesGuide3')
const XqqxGuide4 = () => import('../views/ceping/shengyaceping/view/xqqx/quesGuide4')
const XqqxSuccess1 = () => import('../views/ceping/shengyaceping/view/xqqx/quesSuccess1')
const XqqxSuccess2 = () => import('../views/ceping/shengyaceping/view/xqqx/quesSuccess2')
const XqqxSuccess3 = () => import('../views/ceping/shengyaceping/view/xqqx/quesSuccess3')
const XqqxSuccess4 = () => import('../views/ceping/shengyaceping/view/xqqx/quesSuccess4')
export default[
    {
        path: '/shengyaceping',
        ...
        children:[
            ...
            {
                path: '/shengyaceping/rzqn/144',
                name: 'RzqnQues144',
                component: RzqnQues144
            },
            {
            ...
            {
                path: '/shengyaceping/rzqn/guide/144',
                name: 'RzqnGuide144',
                component: RzqnGuide144,
                meta: {
                    requireAuth: true, // 需要登录
                }
            },
            ...
            {
                path: '/shengyaceping/rzqn/success/144',
                name: 'RzqnSuccess144',
                component: RzqnSuccess144,
                meta: {
                    requireAuth: true, // 需要登录
                }
            },
