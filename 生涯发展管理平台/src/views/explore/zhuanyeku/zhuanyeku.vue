<template>
    <div class="zhuanyeku" id="zhuanyeku" :class="radio1 == 1 ? 'zhuanyeku_benke': 'zhuanyeku_zhuanke'">
        <div class="dingwei" v-show="isShowdingwei">
            <div class="dingwei_inner">
                <div class="inner_box">
                    <div class="searchBox">
        ...
        <div class="undingwei"  v-show="!isShowdingwei">
            <div class="dingwei_inner">
                <div class="inner_box">
                    <div class="searchBox">
                        <input type="text" v-model="searchValue" placeholder="搜索你感兴趣的专业" @keydown.enter="query">
    ...
    methods: {
        ...
        scrollTops() {
            ...
            if(this.scrollTop > 94) {   
                if(this.radio1 == '1') {
                    $('.main_content').css('padding-top','210px')
                }else {
                    $('.main_content').css('padding-top','270px')
                }
